          ...
          <div className={RedeemStyles.subbox}>
           ...
           <div id={RedeemStyles.form}>
                  <div className={RedeemStyles.swapbox1}>
                      <div>
                          <img src={Eth} id="from_token" className={RedeemStyles.coinimg}/>
                          <span id="from_token_text"></span>
                      </div>

                      <div className={RedeemStyles.dollar}><div>$</div></div>

                      <button id={RedeemStyles.max}>MAX</button>


                      <div >
                          <input className={RedeemStyles.input} placeholder="amount" id="from_amount"/>
                      </div>
                  </div>
                  <div className={RedeemStyles.swapbox2}>
                      <div className="swapbox_select token_select"  id="to_token_select">
                          <img src={Logo} id="to_token" className={RedeemStyles.coinimg}/>
                          <span id="from_token_text"></span>
                          <span id="to_token_text"></span>
                      </div>

                      <div className={RedeemStyles.dollar2}><div>$</div></div>


                      <div></div>
                      <div className={RedeemStyles.swapbox_select}>
                          <input className={RedeemStyles.input} placeholder="amount" id="to_amount"/>
                      </div>
                  </div>
                  <div className={RedeemStyles.gas_estimate}>Estimated Gas: <span id={RedeemStyles.gas_estimate}></span></div>

                  <div className={RedeemStyles.Btn}>
                 

                  <button disabled id={RedeemStyles.redeemBtn} className={RedeemStyles.allBtn} >
                      Redeem
                  </button>
                  </div>
              </div>
